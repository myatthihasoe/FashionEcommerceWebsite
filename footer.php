            ...
            <div class="row">
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        ...
                        <a class="text-dark mb-2" href="shop.php"><i class="fa fa-angle-right mr-2"></i>Shopping</a>
                ...
                <div class="col-md-4 mb-5">
                    <h5 class="font-weight-bold text-dark mb-4">Local Payments</h5>
                    <div class="d-flex flex-column justify-content-start">
                        <img  src="img/payments4.png" alt="payments" style="width: 300px; height: 150px;">
                    </div>
                </div>
            </div>
        </div>
...
<!-- Back to Top -->
<a href="nav.php" class="btn btn-primary back-to-top"><i class="fa fa-angle-double-up"></i></a>
