        ...
        <div class="row align-items-center py-3 px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1">M</span>Stylist</h1>
                </a>
            </div>
             <div class="col-lg-6 col-6 text-left"> <!--search bar -->
                <form action="">
            ...
            <div class="col-lg-3 col-6 text-right"> <!--shop icon-->
            <form method="">
            ...
            <div class="col-lg-3 d-none d-lg-block">
                ...
                <nav class="collapse show navbar navbar-vertical navbar-light align-items-start p-0 border border-top-0 border-bottom-0" id="navbar-vertical">
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                         <div class="nav-item dropdown"> <!--Dropdown start -->
                            <a href="shop.php" class="nav-link" data-toggle="dropdown">Dresses <i class="fa fa-angle-down float-right mt-1"></i></a>
                        ...
                        <a href="shop.php" class="nav-item nav-link">Accerssories</a>
                        <a href="shop.php" class="nav-item nav-link">Bags</a> 
                        <a href="shop.php" class="nav-item nav-link">Shoes</a>
                    </div>
                </nav>
            </div>
            <div class="col-lg-9">
                        ...
                        <div class="carousel-item active" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">Traditional and High Quality</h3>
