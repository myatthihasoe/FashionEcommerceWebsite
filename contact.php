            ...
            <div class="col-lg-8 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                    <h1 class="m-0 display-5 font-weight-semi-bold">
                        <<img src="img/Logo5.png" style="width: 90px; height: 90px; object-fit: contain; " alt="Logo">Union Fashion Mall
                    </h1>
                </a>
            </div>
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-block d-lg-none">
                        <h1 class="m-0 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border px-3 mr-1">E</span>Union Fashion Mall</h1>
                    </a>
